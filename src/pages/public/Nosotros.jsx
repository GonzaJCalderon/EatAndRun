      ...
      <section className="pub-section">
        <div className="grid-2">
          ...
          <div className="nos-img-wrap">
            <img src="/fotos/actividad.webp" alt="Nuestra historia" decoding="async" loading="lazy" />
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#f2faf0' }}>
        <div className="pub-section">
          <div className="grid-2 grid-2--reverse">
            ...
            <div className="nos-img-wrap">
              <img src="/fotos/cocina.webp" alt="Nuestra filosofía" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
      </section>
