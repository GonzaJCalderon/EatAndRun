  ...
  return (
    <div className="pub-page">
      ...
      <section className="page-hero">
        <img src="/fotos/empresas2.png" alt="Empresas" className="page-hero__img" />
      ...
      <section className="pub-section">
        <div className="grid-2">
          ...
          <div className="emp-img-wrap">
            <img src="/fotos/Principal2.png" alt="Menús corporativos" />
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#f2faf0' }}>
        <div className="pub-section">
          <div className="grid-2 grid-2--reverse">
            ...
            <div className="emp-img-wrap">
              <img src="/fotos/disfruta.png" alt="Sandwiches para eventos" />
            </div>
          </div>
        </div>
      </section>
