...
const PRODUCTS = [
  { img: '/fotos/granola.png',            name: 'Granola',           desc: 'Granola artesanal con semillas, avena y frutos secos. Ideal para el desayuno o colación.', tag: 'Desayuno',     TagIcon: IcoGranola },
  ...
  return (
    <div className="pub-page">
      ...
      <section className="page-hero">
        <img src="/fotos/granola.png" alt="Productos" className="page-hero__img" />
